...
const I18N = {
  ...
  en: {
    ...
    dayBadge: (name) => `Today is ${name}`,
    flowLoading: "Loading the journey …",
    btnStart: "Begin meditation",
    flowTotal: (min) => `About ${min} minutes in total`,
    flowIteration: (n, hasInstruction) => `Iteration ${n}: ${hasInstruction ? "Instruction · " : ""}Silence · Gong`,
  ...
  fr: {
    ...
    dayBadge: (name) => `Aujourd'hui, c'est ${name}`,
